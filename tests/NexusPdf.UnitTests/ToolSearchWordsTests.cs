...
public sealed class ToolSearchWordsTests
{
    ...
    [Theory]
    [InlineData("кривой скан", CommandIds.EnhanceScans)]
    [InlineData("убрать шум", CommandIds.EnhanceScans)]
    [InlineData("deskew", CommandIds.EnhanceScans)]
    [InlineData("уменьшить размер", CommandIds.CompressPages)]
    [InlineData("compress", CommandIds.CompressPages)]
    [InlineData("линеаризовать", CommandIds.OptimizeCopy)]
